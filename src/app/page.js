...
export default function Homepage() {
  ...
  return (
    <div className="flex flex-row h-screen">
      {/* LEFT PANEL */}
      <div className=" w-1/7 ">
        <div className="mb-5 flex flex-col mx-5 px-6 py-6 space-y-20 justify-center items-center  bg-[#162f4c] rounded-[20px] my-5 h-[95%]">
      ...
      <div className=" md:w-4/6 sm:w-10/12">
        ...
        <div className="relative flex items-center mt-3">
          ...
          <input
            className="h-[40px] bg-gray-800/60 w-full pl-12 pr-5 rounded-xl  border-gray-500/20 focus:outline-none"
            type="text"
        ...
        {weather && current && (
          <>
            <div className="mx-9 justify-between items-center flex flex-row ">
              <div className="flex flex-col space-y-4">
                <div>
                  <div className="font-bold text-3xl">{weather.name}</div>
            ...
            {/* Today's Forecast */}
            <div className="mb-5  bg-[#162f4c] rounded-[20px] flex flex-col mx-5 px-6 py-2 space-y-3">
            ...
            <div className="flex flex-row mx-5 gap-5  rounded-[20px]  bg-[#162f4c]">
              {/* Today' Highlight */}
              <div className=" w-[60%] space-y-5  flex flex-col  py-4">
                <p className="text-gray-500 font-bold uppercase">Today Highlight</p>

                <div className="flex flex-col w-full  border-blue-700  items-center space-y-20">
                {/* 1st column */}
                <div className="flex flex-row w-full  border-red-900">
                  {/* 1st column */}
                  <div className="flex-row flex gap-2 w-1/2">
                    <span><FaWind className="text-[30px]"/></span>
                ...
                {/* second column */}
                <div className="flex flex-row w-full   border-red-90">
                  <div className="flex-row flex gap-2 w-1/2 border-yellow-200">
                    <span><FaWind className="text-[30px]"/></span>
                    <span className="flex flex-col">
              ...
              <div className="mb-5  bg-[#141b32] space-y-5 rounded-[20px] flex flex-col my-4 px-6 items-center justify-center py-4">
                <div className="text-gray-500 font-bold uppercase flex items-center gap-2"> <BsFillSunriseFill className="text-2xl"/>Sunrise</div>
                <div className="text-xl">{daily[0]?.sunrise ? new Date(daily[0].sunrise).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', hour12: true }).toUpperCase() : "-"}</div>
                 ...
                 <div className="text-gray-500 font-bold uppercase flex items-center gap-2"><BsFillSunsetFill className="text-2xl"/>
                 Sunset</div>
      ...
      <div className="  w-2/6 md:block hidden">
        <div className="mb-5  bg-[#162f4c] mt-5 rounded-[20px] flex flex-col mx-5 px-6 py-3 space-y-3">
